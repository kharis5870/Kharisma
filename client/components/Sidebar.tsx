...
import { Home, Users, FileText, Settings, LogOut, PlusCircle, Menu, ArrowLeft, Star, FileSignature } from 'lucide-react';
...
/**
 * Menampilkan nama menu saat sidebar tertutup, karena yang terlihat hanya ikon.
 * Saat sidebar terbuka labelnya sudah tertulis, jadi tooltip dilewati.
 */
...
({ isExpanded, href, icon: Icon, label, active }) => (
    <BungkusTooltip tampil={!isExpanded} label={label}>
        <Link
            to={href}
            className={cn(
