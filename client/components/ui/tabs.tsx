...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      // `border` ditambahkan supaya deretan tab punya batas yang jelas.
      // Sebelumnya bg-muted (96% lightness) di atas latar putih hanya berbeda
      // ~4%, sehingga tab terlihat mengambang menyatu dengan halaman.
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      // Tab aktif diberi `border` + `shadow-sm` supaya benar-benar terangkat
      // dari deretannya, bukan hanya beda 4% kecerahan.
